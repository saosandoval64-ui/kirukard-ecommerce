  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Escríbenos",
      details: ["contacto@kirukard.com", "ventas@kirukard.com"],
    ...
    },
    {
      ...
      description: "Lunes a Viernes de 9am a 6pm",
    },
    {
      icon: MapPin,
      title: "Visítanos",
      details: ["Ciudad de México", "México"],
      description: "Ven a conocer nuestra tienda",
    },
    {
      icon: Clock,
      title: "Horario",
      details: ["Lunes - Viernes: 9am - 6pm", "Sábado: 10am - 4pm"],
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ¿Tienes una duda sobre cartas, sobres o pedidos? Estamos aquí
              para ayudarte.
            </p>
          </div>
        </div>
